...
def check_answer(topic, question, user_answer, is_evening=False):
    if is_evening:
        ...
        Проверь код студента. Укажи:
        1. Правильно или нет
        2. Если ошибка — объясни где именно
        3. Покажи правильный вариант если неправильно
        
        Будь строгим но конструктивным. На русском языке.
        """
    else:
        prompt = f"""
        Тема: {topic['title']}
        ...
        1. Правильно или нет
        2. Что упустил или что лишнее
        3. Правильный ответ одним предложением
